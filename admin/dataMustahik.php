...
$query = mysqli_query($conn, "SELECT * FROM user WHERE kategoriUser='Mustahik' ORDER BY idUser DESC");
?>
<!DOCTYPE html>
<html
  lang="en"
...
<div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data Pengguna /</span> Data Mustahik</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">User Mustahik</h5>
                ...
                <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                            <?php echo"<a href=\"detailUser.php?idUser=$res[idUser]\" type='button' class='btn btn-primary'>Detail</a></td>";
                              ?>
                                    </tr>
                                    <?php
                                    }
