...
$query = mysqli_query($conn, "SELECT * FROM user WHERE kategoriUser='Muzaki' ORDER BY idUser DESC");
?>
<!DOCTYPE html>
<html
  lang="en"
...
<div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data Pengguna /</span> Data Muzaki</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">User Muzaki</h5>
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      <tr>
                        ...
                        ?>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?= $res['nama'];?></strong></td>
                        <td><?= $res['username'];?></td>
                        <td><?= $res['email'];?></td>
                        <td>
                            <div >
                            <?php echo"<a href=\"detailUser.php?idUser=$res[idUser]\" type='button' class='btn btn-primary'>Detail</a>";
                              ?>
                          </div>
                        </td>
                        <?php
