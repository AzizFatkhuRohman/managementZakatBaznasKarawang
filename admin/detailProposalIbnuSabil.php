...
$query = mysqli_query($conn, "SELECT * FROM proposalibnusabil WHERE idProposal=$idProposal");
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Penerimaan /</span> Permohonan Bantuan Ibnu Sabil/Terlantar / Detail</h4>
              <div class="card">
                <?php
                ...
                <div class="card-body">
                    ...
                    <input class="form-control" type="text" value="<?= $res['nama'];?>" aria-label="Disabled input example" disabled readonly>
                    </div>
                    <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Username</label>
                    <input class="form-control" type="text" value="<?= $res['username'];?>" aria-label="Disabled input example" disabled readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <img src="../assets/fileKtp//<?= $res['fileKtp'];?>" alt="Ktp" width='200' height='250'>
                    </div>
                    <div class="mb-3" style='display:grid;'>
                    <label for="exampleFormControlInput1" class="form-label">Keterangan</label>
                    <img src="../assets/fileKeterangan//<?= $res['fileKeterangan'];?>" alt="Ktp" width='200' height='250'>
                    </div>
                </div>
                <?php
                }
