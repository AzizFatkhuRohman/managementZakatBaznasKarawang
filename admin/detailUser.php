        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Penerimaan /</span> Data User / Detail Data User</h4>
              <div class="card">
                <?php
                ...
                <div class="card-body">
                    ...
                    <input class="form-control" type="text" value="<?= $res['email'];?>" aria-label="Disabled input example" disabled readonly>
                    </div>
                    <div class="mb-3">
