...
$idZisd = $_GET['idZisd'];
$query = mysqli_query($conn, "SELECT * FROM penerimaanzisd WHERE idZisd=$idZisd");
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" value="<?= $res['noTransaksi'];?>" aria-label="Disabled input example" disabled readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <input class="form-control" type="text" value="<?= $res['noNpwz'];?>" aria-label="Disabled input example" disabled readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <input class="form-control" type="text" value="<?= $res['jenisDana'];?>" aria-label="Disabled input example" disabled readonly>
                    </div>
                    <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Jumlah Dana</label>
                    <input class="form-control" type="text" value="<?= $res['jumlahDana'];?>" aria-label="Disabled input example" disabled readonly>
                    </div>
                    <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">No Bukti Setor</label>
                    <input class="form-control" type="text" value="<?= $res['noBuktiSetor'];?>" aria-label="Disabled input example" disabled readonly>
                    </div>
                    <div class="mb-3" style='display:grid;'>
                    <label for="exampleFormControlInput1" class="form-label">Bukti Transfer</label>
                    <img src="../assets/fileTransferZisd//<?= $res['fileTransfer'];?>" alt="buktiTransfer" width='200' height='250'>
                    </div>
                </div>
                <?php
                }
