        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pendistribusian /</span> Distribusi Zakat Fitrah</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">Distribusi Zakat Fitrah</h5>
