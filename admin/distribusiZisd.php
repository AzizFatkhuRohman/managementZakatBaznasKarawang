        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pendistribusian /</span> Distribusi Zakat, Infak, Sedekah, DSKL</h4>
              <div class="mb-3">
              <a href="inputDistribusiZisd.php" class='btn btn-success'>Input Laporan Distribusi</a>
              </div>
              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">Distribusi Zakat, Infak, Sedekah, DSKL</h5>
