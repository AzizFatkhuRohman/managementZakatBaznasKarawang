          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                ...
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">No Bukti Penyaluran</label>
                    <input class="form-control" type="text" name='noBuktiPenyaluran' aria-label="Disabled input example">
                    </div>
                    <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Tanggal Transaksi</label>
                    <input class="form-control" type="text" name="tanggal" aria-label="Disabled input example">
                    </div>
                    <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">No KTP/ID</label>
                    <input class="form-control" type="text" name="noKtpId" aria-label="Disabled input example">
                    </div>
                    <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Nama Mustahik</label>
                    <input class="form-control" type="text" name="namaMustahik" aria-label="Disabled input example">
                    </div>
                    <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Alamat</label>
                    <input class="form-control" type="text" name="alamat" aria-label="Disabled input example">
                    </div>
                    <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Asnaf</label>
                    <input class="form-control" type="text" name="asnaf" aria-label="Disabled input example">
                    </div>
                    <div class="mb-3">
                    ...
                    <option value="Advokasi dan Dakwah">Advokasi dan Dakwah</option>
                    <option value="Karawang">Karawang Peduli</option>
                    </select>    
                    </div>
                    <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Jumlah Dana</label>
                    <input class="form-control" type="text" name="jumlahDana" aria-label="Disabled input example">
                    </div>
                    <div class="mb-3" style='display:grid;'>
                    <label for="exampleFormControlInput1" class="form-label">Unggah Bukti Transfer</label>
                    <input class="form-control" type="file" name="buktiTranfer" aria-label="Disabled input example">
                    </div>
                    <div class="mb-3">
                        <input class="btn btn-primary" type="submit" name="submit" value='submit' aria-label="Disabled input example">
                    </div>
                </form>
                </div>
                </div>
