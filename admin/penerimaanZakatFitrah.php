...
$query = mysqli_query($conn, "SELECT * FROM penerimaanzakatfitrah ORDER BY idZakatFitrah DESC");
?>
<!DOCTYPE html>
<html
  lang="en"
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Penerimaan /</span> Penerimaan Zakat Fitrah</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">Zakat Fitrah</h5>
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      <tr>
                        ...
                        <td><?= $res['tanggal'];?></td>
                        <td><?= $res['namaMuzaki'];?></td>
                        <td><?= $res['alamat'];?></td>
                        <td>
                            <div >
                            <?php echo"<a href=\"detailZakatFitrah.php?idZakatFitrah=$res[idZakatFitrah]\" type='button' class='btn btn-primary'>Detail</a>";
                              ?>
                          </div>
                        </td>
                        <?php
