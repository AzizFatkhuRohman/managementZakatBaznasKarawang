...
$query = mysqli_query($conn, "SELECT * FROM `penerimaanzisd` ORDER BY idZisd DESC");
?>
<!DOCTYPE html>
<html
  lang="en"
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Penerimaan /</span> Penerimaan Zakat, Infak, Sedekah, DSKL</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">Zakat, Infak, Sedekah, DSKL</h5>
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      <tr>
                        ...
                        <td>
                            <div >
                              <?php echo"<a href=\"detailZisd.php?idZisd=$res[idZisd]\" type='button' class='btn btn-primary'>Detail</a>";
                              ?>
                          </div>
                          <?php
                        }
