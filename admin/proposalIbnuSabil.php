...
$query = mysqli_query($conn, "SELECT * FROM proposalibnusabil ORDER BY idProposal DESC");
?>
<!DOCTYPE html>
<html
  lang="en"
...
<div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Proposal Permohonan Bantuan /</span> Permohonan Bantuan Ibnu Sabil/Terlantar</h4>
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      <tr>
                        ...
                        <td><?= $res['tanggal'];?></td>
                        <td><?= $res['username'];?></td>
                        <td><?php echo"<a href=\"detailProposalIbnuSabil.php?idProposal=$res[idProposal]\" class='btn btn-primary'>Detail</a></td>"?>
                        <?php
                        }
                        ?>
                      </tr>
