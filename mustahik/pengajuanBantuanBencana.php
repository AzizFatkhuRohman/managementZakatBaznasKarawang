...
>
 ...
 <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pengajuan Proposal /</span> Pengajuan Bantuan Kebencanaan</h4>

              <div class="row">
                <div>
                  <div class="card mb-4">
                    <h5 class="card-header">Input Data Bantuan Kebencanaan</h5>
                    <div class="card-body">
                    ...
                    <div class="mb-3">
                    <label for="formFile" class="form-label">Unggah Keterangan Dari Kepala Desa</label>
                    <input class="form-control" type="file" id="formFile">
                    </div>
                    <div class="mb-3">
                    <label for="formFile" class="form-label">Unggah Rekomendasi Dari UPZ Kecamatan</label>
                    <input class="form-control" type="file" id="formFile">
                    </div>
                    <div class="mb-3">
