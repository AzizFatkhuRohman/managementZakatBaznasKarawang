...
>
 ...
 <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pengajuan Proposal /</span> Pengajuan Program Karawang Sehat</h4>

              <div class="row">
                <div>
                  <div class="card mb-4">
                    <h5 class="card-header">Input Data Program Karawang Sehat</h5>
                    <div class="card-body">
                    <form action="" method="post">
                    <div class="mb-3">
                    <label for="formFile" class="form-label">Unggah Surat Permohonan</label>
                    ...
                    <div class="mb-3">
                    <label for="formFile" class="form-label">Unggah Kartu Keluarga</label>
                    <input class="form-control" type="file" id="formFile">
                    </div>
                    <div class="mb-3">
                    <label for="formFile" class="form-label">Unggah Surat Keterangan Tidak Mampu</label>
                    <input class="form-control" type="file" id="formFile">
                    </div>
                    <div class="mb-3">
                    <label for="formFile" class="form-label">Unggah Rekam Medis</label>
                    <input class="form-control" type="file" id="formFile">
                    </div>
                    <div class="mb-3">
                    <label for="formFile" class="form-label">Unggah Photo Pasien</label>
                    <input class="form-control" type="file" id="formFile">
                    </div>
                    <div class="mb-3">
